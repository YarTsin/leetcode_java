...
Задачи распределены по категориям по особенностям самих задач, их решений и других факторов.

Многие задачи могут находится одновременно в разных категориях. Если вы склонируете проект 
себе на компьютер, то вы сможете искать или наоборот проставлять метки к задачам например: 
...
Технический стек: Для работы используется Windows 11,  Java 8, ИИ и человеческий фактор
поэтому могут быть ошибки в самых неожиданных местах. Проверяйте 
информацию по другим источникам и тестируйте её. 
